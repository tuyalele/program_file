...
/******************************************************************************
                       1:修改产品信息
******************************************************************************/
#define PRODUCT_KEY "9mokjobqofcsj2mq"    //开发平台创建产品后生成的16位字符产品唯一标识
...
//#define         WIFI_CONTROL_SELF_MODE                       //wifi自处理按键及LED指示灯;如为MCU外界按键/LED指示灯请关闭该宏
  ...
  #define     WF_STATE_KEY            P13                   //wifi模块状态指示按键，请根据实际GPIO管脚设置
  #define     WF_RESERT_KEY           P54                     //wifi模块重置按键，请根据实际GPIO管脚设置
#endif
